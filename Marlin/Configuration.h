...
#define STRING_CONFIG_H_AUTHOR "Julien THOMAS" // Original author or contributor.
...
#define DEFAULT_bedKp 94.69
#define DEFAULT_bedKi 016.40
#define DEFAULT_bedKd 364.39
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-44, -2, -0.72}
